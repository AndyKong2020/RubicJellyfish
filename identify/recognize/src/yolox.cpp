...
int yolox_identify(cv::Mat _image){
    try {
...
//        const std::string device_name {argv[3]};
        ...
        CNNNetwork network = ie.ReadNetwork("/home/nuaa/_YOLOX/yolox_s.onnx");
        ...
        cv::Mat image = cv::imread("/home/nuaa/YOLOX/yolox-pytorch/img/street.jpg");
